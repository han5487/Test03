...
public class Practice02 {
	...
	public static Map<String, Integer> catalogMap = new LinkedHashMap<String, Integer>();// <标题，页数>

	public static void main(String[] args) throws Exception {

		System.out.println("catalogMap=" + catalogMap);

		PdfWriter writer = new PdfWriter("D:\\Test\\綜合授信契約書1012-01.pdf");
		...
		catalogMap.put("第一節、營運週轉借款(一般週轉金)", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第二節、透支、存摺存款融資(非證券公司)", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第三節、有價證券(集保、優質股票)融資", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第四節、委任保證", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第五節、墊付國內票款、貼現", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第六節、票據承兌/保證", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第七節、開發國內即期/遠期信用狀", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第八節、開發進口即期/遠期信用狀", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第九節、外銷貸款", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第參章、連帶保證條款", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("第肆章、個別商議條款", document.getPdfDocument().getNumberOfPages());
...
//		list17.add(new ListItem());
		...
		document.add(new Paragraph("附件").addStyle(title22));

		catalogMap.put("附件", document.getPdfDocument().getNumberOfPages());

		document.add(new Paragraph("附件一：核貸通知書").addStyle(title22));

		catalogMap.put("附件一：核貸通知書", document.getPdfDocument().getNumberOfPages());
		...
		catalogMap.put("附件二：企業金融部金融服務各項費用收取標準", document.getPdfDocument().getNumberOfPages());
		...
		document.add(new Paragraph("第壹章、授信共同條款").add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第壹章、授信共同條款"))).addStyle(normal11));

		document.add(new Paragraph("第貳章、個別授信約定條款").add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第貳章、個別授信約定條款"))).addStyle(normal11));

		document.add(new Paragraph("第一節、營運週轉借款(一般週轉金)").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第一節、營運週轉借款(一般週轉金)"))).addStyle(normal11));
		document.add(new Paragraph("第二節、透支、存摺存款融資(非證券公司)").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第二節、透支、存摺存款融資(非證券公司)"))).addStyle(normal11));
		document.add(new Paragraph("第三節、有價證券(集保、優質股票)融資").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第三節、有價證券(集保、優質股票)融資"))).addStyle(normal11));
		document.add(new Paragraph("第四節、委任保證").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第四節、委任保證"))).addStyle(normal11));
		document.add(new Paragraph("第五節、墊付國內票款、貼現").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第五節、墊付國內票款、貼現"))).addStyle(normal11));
		document.add(new Paragraph("第六節、票據承兌/保證").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第六節、票據承兌/保證"))).addStyle(normal11));
		document.add(new Paragraph("第七節、開發國內即期/遠期信用狀").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第七節、開發國內即期/遠期信用狀"))).addStyle(normal11));

		document.add(new Paragraph("第八節、開發進口即期/遠期信用狀").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第八節、開發進口即期/遠期信用狀"))).addStyle(normal11));

		document.add(new Paragraph("第九節、外銷貸款").setFirstLineIndent(45).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第九節、外銷貸款"))).addStyle(normal11));
		document.add(new Paragraph("第參章、連帶保證條款").add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第參章、連帶保證條款"))).addStyle(normal11));
		document.add(new Paragraph("第肆章、個別商議條款").add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("第肆章、個別商議條款"))).addStyle(normal11));
		document.add(
				new Paragraph("附件").add(new Tab()).addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
						.add(String.valueOf(catalogMap.get("附件"))).addStyle(normal11));
		document.add(new Paragraph("附件一：核貸通知書").setFirstLineIndent(25).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("附件一：核貸通知書"))).addStyle(normal11));
		document.add(new Paragraph("附件二：企業金融部金融服務各項費用收取標準").setFirstLineIndent(25).add(new Tab())
				.addTabStops(new TabStop(550, TabAlignment.RIGHT, new DashedLine()))
				.add(String.valueOf(catalogMap.get("附件二：企業金融部金融服務各項費用收取標準"))).addStyle(normal11));
